        ...
        <>
            ...
            <header>
                <div className="logo margin_navbar-logo logo_display">
                    ...
                    <Link href="/" >
                    <img src={`${process.env.SERVER}/img/logo.png`}  className=" wow fadeIn  animated" alt="Logo Img" />
                    </Link>
                    ...
                    <div className="container bg-trans-color nopad">
                        <div className="collapse navbar-collapse" id="navbarSupportedContent1" >
                            ...
                            <ul className="navbar-nav">
                                ...
                                <Link href="/">
                                    <img src={`${process.env.SERVER}/img/logo.png`} className="logo-fix  wow fadeIn  animated" alt="" />
                                </Link>
                                </li>
                            </ul>
                ...
                <div className="outer-window">
                    <div className="navbar_small">
                        ...
                        <div className="logo">
                            ...
                            <Link href="/" >
                                <a className="scroll"><img src={`${process.env.SERVER}/img/logo.png`}  alt="Logo Img" /></a>
                            </Link>    
                        ...
                        <nav className="navbar1">
                            ...
                            <li className="nav-item">
                                <Link  href="/" ><a className="nav-link active wow fadeIn  animated">Home</a></Link>
                            </li>
                            ...
                            <li className="nav-item">
                                <Link href="/rental-equipment" ><a className="nav-link wow fadeIn  animated" >Rental Equipment & Solutions</a></Link>
                            </li>
                            <li className="nav-item">
                                <Link href="/emergency-pressure-care-system" ><a className="nav-link wow fadeIn  animated" >Emergency Pressure Care System</a></Link>
                            </li>
                            <li className="nav-item">
                                <Link href="/complimentary-training" ><a className="nav-link wow fadeIn  animated" >Complimentary Training</a></Link>
                            </li>          
                            <li className="nav-item">
                                <Link href="/total-bed-management-programme" ><a className="nav-link wow fadeIn  animated" >Total Bed Management Programme</a></Link>
                            </li>            
